...
class _DonarDetailsInfoState extends State<DonarDetailsInfo>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(S.of(context).Donar_information),
      ),
      body: _isLoading
          ? Center(
                  ...
                  Container(
                    ...
                    child: Card(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          _buildDetailRow(
                              S.of(context).Name, Icons.person, widget.donar.donarName),
                          Divider(),
                          _buildDetailRow(S.of(context).National_ID, Icons.credit_card,
                              widget.donar.donarId.toString()),
                          Divider(),
                          _buildDetailRow(S.of(context).Blood_type, Icons.favorite,
                              widget.donar.bloodType),
                          Divider(),
                          _buildDetailRow(S.of(context).Blood_type,
                              Icons.calendar_today, widget.donar.createdDate),
                          Divider(),
                          _buildDetailRow(S.of(context).Blood_Type_Expiry_Date, Icons.timer,
                              widget.donar.expiredDate),
                          Divider(),
                          _buildDetailRow(S.of(context).More_Details, Icons.info,
